...
| **Draft-night queue** | `docs/DRAFT_NIGHT_QUEUE_2026-09-08.md` - the adjudicated final top-100 Sleeper autodraft queue for slot 4 with engine digest, ADP timestamp, and the three-way adjudication reasoning (2026-09-08 13:30 ET). Documentation only; no artifact or deployed byte changed. |
| **Draft-night board** | `docs/DRAFT_NIGHT_BOARD_2026-09-08.md` - top-200 board with tags, roster-condition notes, tiers extended to 200, and the rounds 5 to 10 pick guide for slot 4 (2026-09-08 15:00 ET). Documentation only; no artifact or deployed byte changed. |
